...
Teacher1 = ['Last Book Issued: ','Current Book Issued: ']
Teacher2 = ['Last Book Issued: ','Current Book Issued: ']
Teacher3 = ['Last Book Issued: ','Current Book Issued: ']
Teacher4 = ['Last Book Issued: ','Current Book Issued: ']

Teachers = ['Teacher1',Teacher1,'Teacher2',Teacher2,'Teacher3',Teacher3,'Teacher4',Teacher4]
pw = ""
...
def teacher_info():
    ...
    if n==1:
        ...
        name = str(input("Enter Name Of Teacher: "))
        for i in range(0,len(Teachers),2):
            if Teachers[i]==name:
                print(Teachers[i])
                a = Teachers[i+1]
...
def stu_search():
    ...
    for i in range(0,len(Students),1):
        if name == Students[i]:
            ...
            if q > 0:
                print("No child with",name,"name was found")
        te_cont()
